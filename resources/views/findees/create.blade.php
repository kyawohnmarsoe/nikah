...
@if($status == '100')
    <div class="w3-container w3-padding-64 w3-pale-red  w3-wide">
        <div class="alert alert-success">
            <h2 class="w3-center" style="color:brown;">"Registarion Closed!"</h2>
            <p class="w3-center" style="color:brown;">Sorry! Number of Registrants is reach to it's limit! </br>
                You can join in the next round.</p>
        </div>
    </div>
@else
    <div class="w3-container w3-padding-64 w3-pale-red  w3-wide">
            ...
            <form id="register" class="w3-container" enctype="multipart/form-data"
                ...
                <div class="w3-row">
                    <p class="w3-col m6">
                        ...
                        <input class="w3-input w3-border w3-sand @error('race') is-invalid @enderror" required
                            name="race" type="text" placeholder="Sunni, Shia, Whabbi, Kachin, Mon, Shan etc"
                            value="{{ old('race') }}">
                    </p>
                ...
                <div class="w3-row">
                    <p class="w3-col m6">
                        ...
                        <input class="w3-input w3-border w3-sand @error('height') is-invalid @enderror" required
                            name="height" type="text" placeholder="5 ft 9 in"
                            value="{{ old('height') }}">
                    </p>
                ...
                <p class="w3-col m12">
                    ...
                    <textarea rows="2" class="w3-input w3-border w3-sand @error('hobbies') is-invalid @enderror"
                ...
                <p class="w3-col m12">
                    <label class="w3-text-brown"><b>Socialmedia Profile (Facebook, Instragram,
                            etc)</b></label>
                    <input class="w3-input w3-border w3-sand @error('socialmedia') is-invalid @enderror"
                        name="socialmedia" type="url" placeholder="https://facebook.com/your_user_name_id"
